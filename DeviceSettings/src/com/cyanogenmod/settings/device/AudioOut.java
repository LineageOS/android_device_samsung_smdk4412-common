...
public class AudioOut extends DialogPreference implements SeekBar.OnSeekBarChangeListener {
    ...
    public static void restore(Context context) {
        ...
        if (isSupported("headphone"))
            Utils.writeValue(AUDIOOUT_HEADPHONE_FILE, sharedPrefs.getString(AUDIOOUT_HEADPHONE_FILE, "0"));
        if (isSupported("speaker"))
            Utils.writeValue(AUDIOOUT_SPEAKER_FILE, sharedPrefs.getString(AUDIOOUT_SPEAKER_FILE, "0"));
    }
