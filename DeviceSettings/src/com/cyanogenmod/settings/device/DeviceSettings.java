...
public class DeviceSettings extends FragmentActivity {
    ...
    public static final String KEY_INCALL_EARPIECE = "incall_earpiece";
    ...
    public static final String KEY_AUDIOOUT_SPEAKER = "audioout_speaker";
    public static final String KEY_AUDIOOUT_HEADPHONE = "audioout_headphone";
