		...
		if (width == 0 || height == 0) {
			...
			if (exynos_camera->camera_videosnapshot_resolutions != NULL && !exynos_camera->camera_fimc_is && exynos_camera->camera_sensor_mode == SENSOR_MOVIE) {
				for (i = 0; i < exynos_camera->camera_videosnapshot_resolutions_count; i++) {
					if (exynos_camera->camera_videosnapshot_resolutions[i].video_width == exynos_camera->capture_width && exynos_camera->camera_videosnapshot_resolutions[i].video_height == exynos_camera->capture_height) {
